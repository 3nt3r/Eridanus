<footer class="page-footer light-green accent-4">
  <div class="container">
    <div class="row">
      ...
      <div class="col l4 offset-l2 s12">
        ...
        <ul>
          <li><a class="grey-text text-lighten-3" href="https://www.facebook.com/ProjetoEridanus" target="_blank">Facebook</a></li>
  ...
  <center>
    <div>
    	<a class="grey-text text-lighten-3" href="https://softwarecalisto.000webhostapp.com/eridanus.php" target="_blank">Artefatos /</a>
