...
<div class="toggle flow-text">
	<p id="texto-residuos">
		...
		<br>
		Nossa proposta é realizar a coleta de resíduos eletrônicos e reutilizá-los através da criação de novos projetos, seja pelos desenvolvedores deste projeto ou
		...
		<br>
		Qualquer pessoa que esteja disposto a contribuir com o meio ambiente reciclando resíduos eletrônicos, enviando projetos criados a partir do lixo eletrônico, objetos para trocas, 
		...
		<br>
		<br>
		<h5><b>As informações acima não foram suficientes? Entre em contato e nos diga sua dúvida.</b></h5>
