     ...
     <div class="col s2 m2 l2"></div>
         <div class="col s8 m8 l8">
             <div class="card-panel teal light-green accent-4">
               <center> <span class="white-text titulo-partes-projeto">Redefinir senha! </span> </center>
             </div>
         </div>
     <div class="col s2 m2 l2"></div>
</div>
...
<div class="row">
  ...
  <div class="input-field col s12 m10 l6">
     ...
     <br><button style="margin-top: 20px; margin-bottom: 70px;" class="btn light-green accent-4" type="submit" name="button">Redefinir</button>
   </div>
   <div class="col m1 l3 "> </div>
