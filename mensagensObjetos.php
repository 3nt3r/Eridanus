<?php
  ...
  $consulta = "SELECT mensagem.conteudo, mensagem.id_emi, mensagem.id_rec, mensagem.id_objeto, objeto.nome, usuario.nome FROM mensagem INNER JOIN objeto on mensagem.id_rec = ? inner join usuario on mensagem.id_emi = usuario.id";
